...
VCC_BEND = 520
DECAP_X = 640
# 电容极板尺寸: 极板长:板间白缝 ≈ 2:1 才像标准电容 (对标官方 18:10)
# 反馈 C 在 fb=385, 夹在盒底(370)与GND轨(400)间, 极板高上限~20; 取18 (上下各余~5px)
# (旧值 间距28/高14 是板短缝宽的反比, 视觉上像"变形" -> 用户指正)
PLATE_GAP, PLATE_H = 5, 9          # 反馈 C: 板长18 / 板间距10 -> 白缝7.5px 视觉比2.4 (旧 28/14 反比"变形")
